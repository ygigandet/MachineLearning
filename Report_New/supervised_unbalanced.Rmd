...
```
#AMINA'S PART START
After applying these methods and plotting the "importance" of variables, we see that variables half time result,half time home goal, away shots on target and half time away goals are the ones who contribute most to the predictions of the game results. Indeed, not including theses variables can cause change either positively or negatively. Thus, in the 4 importance variables we have half time result and half time home goal which affect positively and we have away shots on target and half time away goals which affect negativly. 
