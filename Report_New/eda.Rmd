...
# ggplot(HK_WQ_Analysis, aes(x = `Dissolved Oxygen (mg/L)`, y = Year, fill = 0.5 - abs(0.5 - stat(ecdf)))) +
#   stat_density_ridges(scale = 0.9, geom = "density_ridges_gradient", calc_ecdf = TRUE, quantile_lines = TRUE, alpha = 0.75, quantiles = 2) +
#   scale_fill_gradient(low= "#008a89", high = "yellow", name= "Tail probability") +
