...
```{r, echo=FALSE}
violin.goalsH <- ggplot(premier_league_results, aes(x=home_team, y=full_time_home_goals, fill=home_team)) + # fill=name allow to automatically dedicate a color for each group
  geom_violin() + geom_boxplot()


violin.goalsA <- ggplot(premier_league_results, aes(x=away_team, y=full_time_away_goals, fill=away_team)) + # fill=name allow to automatically dedicate a color for each group
  geom_violin() + geom_boxplot()
...
```{r, echo=FALSE}
violin.cardsH <- ggplot(premier_league_results, aes(x=home_team, y=home_red_cards, fill=home_team)) + # fill=name allow to automatically dedicate a color for each group
  geom_violin() + geom_boxplot()

violin.cardsA <- ggplot(premier_league_results, aes(x=away_team, y=away_red_cards, fill=away_team)) + # fill=name allow to automatically dedicate a color for each group
  geom_violin() + geom_boxplot()
...
```{r, echo=FALSE}
#Need to fix this
premier_league_results %>% dplyr::select(where(is.numeric)) %>% 
plot_correlation() 
```
