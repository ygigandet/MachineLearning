...
premier_league_results_1617 <- subset(premier_league_results_1617, select = -c(LBH,LBD,LBA))
...
unique(premier_league_results_1617$HomeTeam) %>% knitr::kable(caption = "**Table 3: Premier League Teams 2018-19**", col.names = "Teams") %>% kable_styling(bootstrap_options = c("striped","hover","condensed"), fixed_thead = T)
...
In the remaining teams, Brighton, Huddersfield, Newcastle were not playing in the 2016-17 season. Additionally, the teams Hull, Middlesbrough and Sunderland were not playing in the following seasons neither. We should take them out
