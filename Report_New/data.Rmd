...
unique(premier_league_results_1718$HomeTeam) %>% knitr::kable(caption = "**Table 1: Premier League Teams 2017-18**", col.names = "Teams") %>% kable_styling(bootstrap_options = c("striped","hover","condensed"), fixed_thead = T)

unique(premier_league_results_1819$HomeTeam) %>% knitr::kable(caption = "**Table 2: Premier League Teams 2018-19**", col.names = "Teams") %>% kable_styling(bootstrap_options = c("striped","hover","condensed"), fixed_thead = T)

unique(premier_league_results_1617$HomeTeam) %>% knitr::kable(caption = "**Table 3: Premier League Teams 2016-17**", col.names = "Teams") %>% kable_styling(bootstrap_options = c("striped","hover","condensed"), fixed_thead = T)
