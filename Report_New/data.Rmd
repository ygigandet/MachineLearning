...
# Remove the first column - namely league_division

premier_league_results <- premier_league_results %>% 
  select(-league_division)

# Remove referee variable

premier_league_results <- premier_league_results %>% 
  select(-referee)

# Remove all the variables from betting website - because they contain information about what we want to predict
