...
```
<div>
For our project, we will be providing a prediction of the Premier League rankings. We will be using datasets from xxx, called xxx containing the results of Premier League games for seasons 2016-17, 2017-18 and 2018-19. Below are the variables in the datasets and their details:
</div>
 + `xxx` - ...
 + `xxx` - ...
 + `xxx` - ...
...
premier_league_results <- subset(premier_league_results, HomeTeam!=teams_to_remove & AwayTeam!=teams_to_remove)
```
