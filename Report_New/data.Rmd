...
We will be using datasets containing the results of Premier League games for seasons 2016-17, 2017-18 and 2018-19.
...
Each of the three datasets contains 380 observations, and each of them represents one match. The dataset for the season 2018-19 contains 62 variables, while the other two datasets contain 65 variables each. The most important variables that we are going to use in this project are the following:
...
As it can be seen, all the variables concern the performance of either the home or the away team during a specific match.jj
...
unique(premier_league_results_1718$HomeTeam) %>% knitr::kable(caption = "**Table 1: Premier League Teams 2017-18**", col.names = "Teams") %>% kable_styling(bootstrap_options = c("striped","hover","condensed"), fixed_thead = T) %>% kable_paper() %>%  scroll_box(width = "100%", height = "320px")

unique(premier_league_results_1819$HomeTeam) %>% knitr::kable(caption = "**Table 2: Premier League Teams 2018-19**", col.names = "Teams") %>% kable_styling(bootstrap_options = c("striped","hover","condensed"), fixed_thead = T) %>% kable_paper() %>%  scroll_box(width = "100%", height = "320px")

unique(premier_league_results_1617$HomeTeam) %>% knitr::kable(caption = "**Table 3: Premier League Teams 2016-17**", col.names = "Teams") %>% kable_styling(bootstrap_options = c("striped","hover","condensed"), fixed_thead = T) %>% kable_paper() %>%  scroll_box(width = "100%", height = "320px")
...
Finally, let's check if our final dataset contains missing values.
