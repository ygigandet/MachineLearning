...
unique(premier_league_results_1718$HomeTeam)
unique(premier_league_results_1819$HomeTeam)
```
...
premier_league_results %>% knitr::kable(caption = "**Table 1: Premier League results (seasons 2017-18 and 2018-2019)**") %>% 
