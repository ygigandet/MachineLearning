...
For our project, we will be providing a prediction of the Premier League rankings. We will be using several datasets to which we will apply different models to get a prediction then test it's accuracy.
...
The third dataset `players_stats` is about the statistics of the players of the Premier League until september 2020. This dataset contains 59 variale combining all details for each Premier League player such as their club, position, nationality, wins, losses, passes, saves, and much more.
