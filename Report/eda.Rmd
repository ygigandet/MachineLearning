...
highest_wins_perc <- plot_ly(WithPercentage, x = ~Name, y = ~Wins_Perc, type = 'bar', name = 'Wins Percentage per player') 
...
age_wins_corrplot <- plot(WithPercentage$Age, WithPercentage$Wins_Perc, pch = 19, col = "blue")
abline(lm(WithPercentage$Wins_Perc~WithPercentage$Age), col = "red", lwd = 3)
text(paste("Correlation:", round(cor(WithPercentage$Age, WithPercentage$Wins_Perc), 7)), x = 25, y = 95)
