...
#Limitation: We do not have the number of minutes which each player played. Some of their apperences might include only 10 minutes and some might be 90 minutes but we do not have data that is that detailed.
